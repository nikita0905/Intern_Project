...
if(!$product_id){
$_SESSION['msg']='Please select product to upload images';
...
if(isset($_GET['todo']) && $_GET['todo']=='edit'){
    ...
    $rs = mysql_query("select * from `product_img` where `id`=".$id);
...
if (isset($_POST['formact']) && $_POST['formact'] == 'addimg') {
    ...
    $rs = mysql_query("INSERT INTO `product_img`(`product_id`,`img_name`, `img_file`)"
            . " VALUES ('".$product_id."','" . $name . "','" . $imgname . "')" );
...
if (isset($_POST['formact']) && $_POST['formact'] == 'editimg') {
    ...
    $rs = mysql_query("UPDATE  `product_img` set `img_name`='".$name."',`img_file`='".$file."',`product_id`='".$product_id."' where `id`=".$id);
...
<?php } ?>
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="<?php echo $base_path; ?>product/prod_img.php?product_id=<?php echo $product_id;?>">
