                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php
                                $pagesize=PAGESIZE;
                                $rs = mysql_query("select * from `category` where $cond and `type`='image'");
                                $num = mysql_num_rows($rs);
                                $pageindex=isset($_GET['pageindex'])? $_GET['pageindex']:0;
                                $totalpage=  ceil($num/$pagesize);
                                if($num){
                                    $rspage = mysql_query("select * from `category` where $cond and `type`='image' limit ".($pageindex*$pagesize).",".$pagesize);
