                                ...
                                <div class="table-responsive">
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-heading">
                                            <div class='row'>  <div class="col-md-90 col-sm-90 col-xs-90"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;Users</div>

                                                <div class="col-md-10 col-sm-10 col-xs-10">
                                                    <a href="addusers.php" class="btn btn-default"> <span class="glyphicon glyphicon-plus"></span></a>
                                                </div>
                                            </div>
                                        </div>
                                        <form method="POST" action="index.php" name="frm" id="frm">
                                            <table class="table table-bordered">
                                                <tbody>
                                                    ...
                                                    $rs = mysql_query("select * from `user` where $cond and `GROUP` = 2 ");
                                                    $num = mysql_num_rows($rs);
                                                    $pageindex = isset($_GET['pageindex']) ? $_GET['pageindex'] : 0;
                                                    $totalpage = ceil($num / $pagesize);

                                                    if ($num) {
                                                        $rspage = mysql_query("select * from `user` where $cond and `GROUP`=2 order by ord ASC limit " . ($pageindex * $pagesize) . "," . $pagesize);
                                                        while ($row = mysql_fetch_array($rspage)) {
                                                            ...
                                                            <tr id="rid<?php echo $row['ID']; ?>">
                                                                ...
                                                                <td class="tdaction">
                                                                    <a href="addusers.php?todo=edit&id=<?php echo $row['ID'] ?>"><span class="glyphicon glyphicon-edit"></span></a>
