...
if(isset($_GET['formact']) && $_GET['formact']=='search'){
    $cond.=" and `page_title` Like '%".$_GET['keyword']."%' ";
}
...
if (isset($_POST['formact']) && $_POST['formact'] == 'del') {
    ...
    foreach ($checkrec as $key => $val) {
        mysql_query("delete from `pages` where `ID`=" . $val);
    }
    $_SESSION['msg'] = "Pages deleted successfully";
    header("Location:index.php");
    exit();
}
?>
                        ...
                        <div class="table-responsive">
                         <div class="panel panel-primary">
                                ...
                                <div class="panel-heading">
                                  <div class='row'>  <div class="col-md-90 col-sm-90 col-xs-90"><span class="glyphicon glyphicon-file"></span>&nbsp;&nbsp;Pages</div>
                                
                                <div class="col-md-10 col-sm-10 col-xs-10">
                                    <a href="addpages.php" class="btn btn-default"> <span class="glyphicon glyphicon-plus"></span></a>
                                </div>
                                  </div>
                            </div>
                            ...
                            <table class="table table-bordered">
                               ...
                               <!--         <td><strong>META TITLE</strong></td>
                                        ...
                                        <td><strong>TOP MENU NAME</strong></td>
                                        <td><strong>FOOTER MENU NAME</strong></td>
                                        <td><strong>ORDER</strong></td>
                                        <td><strong>ACTIONS</strong></td>
                                    </tr>
                                    <?php
                                             $pagesize=PAGESIZE;
                                             $rs = mysql_query("select * from `pages` where $cond and `status` = 1");
                                            ...
                                            if ($num) {
                                                $rspage = mysql_query("select * from `pages` where $cond and `status`=1 limit ".($pageindex*$pagesize).",".$pagesize);
                                          ...
                                          <!--              <td><?php echo $row['meta_title']; ?></td>
                                                        ...
                                                        <td><?php echo $row['top_menu_name']; ?></td>
                                                        <td><?php echo $row['footer_menu_name']; ?></td>
                                                        <td class="tdaction"><a>&#9660;</a>&nbsp;&nbsp;&nbsp; <a>&#9650;</a></td>
                                                        <td class="tdaction">
                                                            <a href="addpages.php?todo=edit&id=<?php echo $row['id'] ?>"><span class="glyphicon glyphicon-edit"></span></a>
...
<!--<a href="#" onclick="deleteAjx('<?php echo $row['ID'];?>')"><span class="glyphicon glyphicon-trash"></span></a> -->
                                            ...
                                            ?> <!--<tr><td colspan='8'> <div class="col-md-offset-80 col-md-20"><input type="hidden" name="formact" id="formact" value="" />
