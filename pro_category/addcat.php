...
if (isset($_POST['formact']) && $_POST['formact'] == 'addcat') {
    ...
    $rs = mysql_query("INSERT INTO `category`(`name`,`description`, `add_date`, `ord`,`type`,`status`)"
            . " VALUES ('" . $name . "','" .$desc. "'," . time() . ",'99999.00','product',1)");
    $_SESSION['msg']= "Category inserted successfully";
    header("Location:" . $base_path . "pro_category/index.php");
    exit();
    }
}   
                       ...
                       <div class="row" id="error">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" role="form" action="<?php echo $base_path; ?>pro_category/addcat.php" method="post">
