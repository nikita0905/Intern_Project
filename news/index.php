                    ...
                    if (isset($_SESSION['msg']) && $_SESSION['msg'] != '') {
                        ...
                        <div class="row" id="error">
                            <div class="col-md-100">
                                <div class="alert alert-success"><div class="row"><div class="col-md-90"><?php echo $_SESSION['msg']; ?></div><div class="col-md-1">
                        ...
                        <div class="table-responsive">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-heading">
                                  <div class='row'>  <div class="col-md-90 col-sm-90 col-xs-90"><span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;News</div>
                                
                                <div class="col-md-10 col-sm-10 col-xs-10">
                                    <a href="addnews.php" class="btn btn-default" > <span class="glyphicon glyphicon-plus"></span></a>
                                </div>
                                  </div>
                            </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php
                                $pagesize=PAGESIZE;
                                $rs = mysql_query("select * from `news` where $cond and `STATUS` = 1");
                                $num = mysql_num_rows($rs);
                                $pageindex=isset($_GET['pageindex'])? $_GET['pageindex']:0;
                                $totalpage=  ceil($num/$pagesize);
                                if($num){
                                    $rspage = mysql_query("select * from `news` where $cond and `status`=1 limit ".($pageindex*$pagesize).",".$pagesize);
                                    ...
                                    <td class="tdaction"> <a href="index.php?todo=setord&action=down&tid=<?php echo $rowUser['id'] ?>">&#9660;</a> &nbsp;&nbsp;&nbsp; <a href="index.php?todo=setord&action=up&tid=<?php echo $rowUser['id'] ?>">    &#9650;  <a>  </td>
                                    <td class="tdaction">
                                        <a href="addnews.php?todo=edit&id=<?php echo $row['id'] ?>"><span class="glyphicon glyphicon-edit"></span></a>
